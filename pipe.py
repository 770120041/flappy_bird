...
class Pipe():
    def __init__(self, board_height, board_width):
        ...
        self.max_pip_body_number = (self.board_height - self.interval_length - 2 * self.pipe_head_height) // self.pipe_body_height

        # body number
        self.up_body_number = random.randint(0, self.max_pip_body_number)
        self.down_body_number = self.max_pip_body_number - self.up_body_number
    ...
    def construct_pipe(self):
        ...
        self.pipe_group.add(pipe_head.PipeHead(self.x, self.pipe_body_height * self.up_body_number))
        ...
        self.pipe_group.add(pipe_head.PipeHead(self.x, self.board_height - (self.down_body_number)*self.down_body_number - self.pipe_head_height))
